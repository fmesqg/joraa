...
export function buildSearchQueryUrl(formData, page, pageSize) {
  const query = `searchText=&estados=6&page=${page}&pageSize=${pageSize}&importados&fromDate=${formData.fromDate}&toDate=${formData.toDate}&serie=${formData.serie}&tipoAto=${formData.tipo}&entidade=${formData.entidade}&ordenacao=0`;
